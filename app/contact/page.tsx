  ...
  return (
    <div className="bg-mg-bg">
      <div className="mx-auto max-w-2xl px-5 pb-24 pt-16 sm:px-8 sm:pt-24">
        <Reveal>
          <p className="font-marginalia-sans text-[13px] text-mg-ink-faint">Contact</p>
        ...
        <Reveal delay={0.08} className="mt-12 flex flex-col gap-6 rounded-[2px] border border-mg-line bg-mg-bg-raised p-7 sm:p-9">
          <div className="flex flex-wrap items-center gap-3">
            <span className="h-2 w-2 rounded-full bg-mg-accent" aria-hidden />
            <span className="font-marginalia-sans text-[13.5px] text-mg-ink-muted">Currently open to freelance contracts and full-time roles.</span>
          </div>
